  ...
  return (
    ...
    >
      ...
      <g>
        ...
        <rect x="6" y="22" width="10" height="8" rx="2" fill="#E8362E" />
        <rect x="7" y="20" width="8" height="3" rx="1" fill="#fff" opacity="0.6" />
        {/* Wing endplates */}
        <rect x="4" y="24" width="2" height="6" rx="0.5" fill="#E8362E" opacity="0.8" />
        <rect x="16" y="24" width="2" height="6" rx="0.5" fill="#E8362E" opacity="0.8" />
      </g>
      ...
      <g>
        {/* Helmet base */}
        <ellipse cx="98" cy="44" rx="14" ry="12" fill="#E8362E" />
      ...
      <g>
        ...
        <rect x="204" y="28" width="12" height="6" rx="2" fill="#E8362E" />
        <rect x="206" y="26" width="8" height="3" rx="1" fill="#fff" opacity="0.5" />
        {/* Endplates */}
        <rect x="218" y="36" width="4" height="44" rx="1.5" fill="#E8362E" opacity="0.9" />
      ...
      {/* === BRAKE LIGHTS === */}
      <motion.ellipse
        cx="28" cy="50" rx="2" ry="3" fill="#E8362E"
      ...
      <g transform={`translate(34, 96) rotate(${wheelRotate})`}>
        ...
        {/* Center hub */}
        <circle cx="0" cy="0" r="2" fill="#E8362E" />
      </g>
      ...
      <g transform={`translate(205, 96) rotate(${wheelRotate})`}>
        ...
        <circle cx="0" cy="0" r="1.5" fill="#E8362E" />
      </g>
    </svg>
  );
}
